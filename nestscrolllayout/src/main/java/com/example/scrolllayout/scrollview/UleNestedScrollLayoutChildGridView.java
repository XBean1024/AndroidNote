 ...
 * date 2018/5/3
 */
public class UleNestedScrollLayoutChildGridView extends GridView implements NestedScrollingChild {
    private NestedScrollingChildHelper mScrollingChildHelper;
    public UleNestedScrollLayoutChildGridView(Context context) {
        super(context);
        init(context);
    }

    public UleNestedScrollLayoutChildGridView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public UleNestedScrollLayoutChildGridView(Context context, AttributeSet attrs, int defStyleAttr) {
